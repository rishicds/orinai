      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-12 px-6 py-12 lg:py-16">
        <header className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div className="flex flex-col">
            <span className="text-xs font-bold uppercase tracking-[0.4em] text-blue-400">
              Orin.ai
            </span>
            ...
            {user ? (
              <>
                ...
                <form action={logoutUser}>
                  <button
                    type="submit"
                    className="rounded-lg border border-slate-700 bg-slate-800/50 px-4 py-2 text-slate-200 transition hover:border-blue-500 hover:bg-slate-800"
                  >
                    Sign out
                  </button>
                </form>
